...
/* harmony import */ var _sliders__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./sliders */ "./src/js/sliders.js");
...
/* harmony import */ var _modules_skills__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/skills */ "./src/js/modules/skills.js");
...
window.addEventListener('DOMContentLoaded', function () {
  Object(_sliders__WEBPACK_IMPORTED_MODULE_4__["default"])(jquery__WEBPACK_IMPORTED_MODULE_1___default.a);
  Object(_modules_accordeon__WEBPACK_IMPORTED_MODULE_2__["default"])('.accordion-heading');
  Object(_modules_scrolling__WEBPACK_IMPORTED_MODULE_3__["default"])('.pageup', jquery__WEBPACK_IMPORTED_MODULE_1___default.a);
  ...
  Object(_modules_skills__WEBPACK_IMPORTED_MODULE_6__["default"])();
});
...
var burger = function burger() {
  ...
  burger.addEventListener('click', function () {
    ...
    if (menu.classList.contains('active')) {
      nav.style.minHeight = "".concat(nav.scrollHeight + 160 + menuitem.scrollHeight, "px");
  ...
  window.addEventListener('scroll', function () {
    menuitem.forEach(function (item, i) {
      ...
      var id = item.childNodes[0].getAttribute('href'),
...
var scrolling = function scrolling(upSelector, $) {
  ...
  var para = document.querySelector('.header nav');
  var compStyles = window.getComputedStyle(para);
  var height = compStyles.getPropertyValue('min-height').match(/(\d+)/);
  window.addEventListener('scroll', function () {
    var topercent = document.documentElement.scrollTop / document.documentElement.scrollHeight * 100;
...
var skills = function skills() {
  var barwrapper = document.querySelectorAll('.progress_bar_text > .percent'),
      barshow = document.querySelectorAll('.progress_bar_bar  .main  .main_show'),
      skillsblock = document.querySelector('.skills_block');
  var shown = false;
  var y = window.addEventListener('scroll', function () {
    if (shown == false) {
      if (skillsblock.offsetTop - 95 + 110 >= window.pageYOffset) {
        shown = true;
        barwrapper.forEach(function (item) {
          var goal = +item.getAttribute('data-prc');
          var per = 0;
          var starttime;
        ...
        barshow.forEach(function (item) {
          var goal = +item.getAttribute('data-prc');
          item.style.width = "".concat(goal, "%");
        });
      }
    } else {}
  });
...
function moveit(timestamp, duration, starttime, item, per, goal) {
  ...
  item.innerHTML = "".concat(progress, "%");
